...
class GridstackComponent {
    ...
    ngOnInit() {
        ...
        this._zone.runOutsideAngular(() => {
            ...
            const /** @type {?} */ el = ( /** @type {?} */($(this._el.nativeElement))).gridstack(this.options);
            ...
            $(this._el.nativeElement).on('added', (evt, items) => {
                ...
                const /** @type {?} */ existingItemIds = ( /** @type {?} */(this._gridstack)).grid.nodes.map(i => $(i.el)
                    .attr('class')
                    .split(/\s+/)
     ...
     */
    ngOnChanges(changes) {
        const /** @type {?} */ heightChanges = changes['height'];
        const /** @type {?} */ optionsChanges = changes['options'];
        ...
        if (optionsChanges && !optionsChanges.isFirstChange()) {
            const /** @type {?} */ prev = optionsChanges.previousValue;
            const /** @type {?} */ curr = optionsChanges.currentValue;
